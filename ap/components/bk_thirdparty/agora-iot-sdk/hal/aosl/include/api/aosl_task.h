...
extern __aosl_api__ int aosl_task_prepare (aosl_stack_id_t stack_id, const char *f_name, aosl_prepare_func_t f, uintptr_t argc, ...);
extern __aosl_api__ int aosl_task_prepare_args (aosl_stack_id_t stack_id, const char *f_name, aosl_prepare_func_t f, uintptr_t argc, va_list args);
extern __aosl_api__ int aosl_task_prepare_argv (aosl_stack_id_t stack_id, const char *f_name, aosl_prepare_func_t f, uintptr_t argc, uintptr_t argv []);
...
extern __aosl_api__ int aosl_task_resume (aosl_stack_id_t stack_id, const char *f_name, aosl_resume_func_t f, uintptr_t argc, ...);
extern __aosl_api__ int aosl_task_resume_args (aosl_stack_id_t stack_id, const char *f_name, aosl_resume_func_t f, uintptr_t argc, va_list args);
extern __aosl_api__ int aosl_task_resume_argv (aosl_stack_id_t stack_id, const char *f_name, aosl_resume_func_t f, uintptr_t argc, uintptr_t argv []);
