...
/**
 * @brief Initialize audio decode resources (thread and semaphore)
 *
...
/**
 * @brief Deinitialize audio decode resources (thread and semaphore)
 *
 * @param controller Controller pointer
 */
...
/**
 * @brief Add audio decoder to decoder list
 *
 * @param controller Controller pointer
 * @param decoder_ops Audio decoder operations
 * @return avdk_err_t AVDK_ERR_OK on success, error code on failure
 */
avdk_err_t bk_video_player_audio_decoder_list_add(private_video_player_ctlr_t *controller, const video_player_audio_decoder_ops_t *decoder_ops);

/**
 * @brief Clear all registered audio decoders
 *
 * This API releases all audio decoder registration nodes in controller->audio_decoder_list.
