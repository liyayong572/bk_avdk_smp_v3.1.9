...
static int32_t dm_ble_gap_common_cb(bk_ble_gap_cb_event_t event, bk_ble_gap_cb_param_t *param)
{
    ...
    case BK_BLE_GAP_BOND_KEY_GENERATE_EVT:
    {
                ...
                pm->bond_dev.bond_key.lenc_key.sec_level == BK_BLE_SECURITY_LEVEL_4)
        {
            ...
            extern void bt_manager_start_reconnect(uint8_t *addr, uint8_t immediate);
            extern void bt_clear_reconnect_time(void);
            bt_clear_reconnect_time();
            bt_manager_start_reconnect(pm->bond_dev.bond_key.pid_key.static_addr,1);
            bluetooth_storage_save_linkkey_info(pm->bond_dev.bond_key.pid_key.static_addr, pm->bond_dev.bond_key.llink_key.key);
        }
#endif
...
int dm_gatt_init(void)
{
    ...
    gatt_logi("set BK_BLE_SM_SET_ER start");
    ...
    gatt_logi("set BK_BLE_SM_SET_IR start");
