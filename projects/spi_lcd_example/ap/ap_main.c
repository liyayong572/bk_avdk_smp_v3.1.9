...
void cli_spi_lcd_display_cmd(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv)
{
    ...
    if (os_strcmp(argv[1], "open") == 0) {
        ...
        if (argc > 2) {
            if(os_strtoul(argv[2], NULL, 10) == 1)
            {
				lcd_spi_display_fill_pure_color(disp_frame, RED_COLOR);
			}
			else if(os_strtoul(argv[2], NULL, 10) == 2)
			{
				lcd_spi_display_fill_pure_color(disp_frame, GREEN_COLOR);
			}
			else if(os_strtoul(argv[2], NULL, 10) == 3)
			{
				lcd_spi_display_fill_pure_color(disp_frame, BLUE_COLOR);
			}	
        }
		else
		{
